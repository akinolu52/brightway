		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3">
					<div class="pro_logo"> <a href="/"><img src="images/header/Logo_yellow.png" alt="logo" /></a> </div>
				</div>
	...
	<section class="ed_mainslider">
		<article class="content">
			<div class="rev_slider_wrapper">			
				...
				<ul>    <!-- SLIDE  -->
					<li data-index="rs-2978" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="images/slider/slider1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Transportations" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="images/slider/slider1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgparallax="3" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						...
						<div class="tp-caption tp-shape tp-shapewrapper  rs-parallaxlevel-3" 
							...
							style="z-index: 6;text-transform:left;background-color:rgb(252, 169, 1);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>
						...
						<div class="tp-caption Creative-SubTitle   tp-resizeme rs-parallaxlevel-2" 
							...
							style="z-index: 7; white-space: nowrap;text-transform:left;  font-family: 'Trirong', serif;">WE ASSURE YOU OF OUR BEST SERVICES AT ALL TIMES</div>
						...
						<div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1" 
							...
							style="z-index: 8; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">All Type Of<br/>Transportations</div>
						...
						<div class="tp-caption tp-shape tp-shapewrapper  rs-parallaxlevel-3" 
							...
							style="z-index: 9;text-transform:left;background-color:rgb(252, 169, 1);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>
						...
						<div class="tp-caption Creative-Button rev-btn  rs-parallaxlevel-15" 
							...
							style="z-index: 10; white-space: nowrap;text-transform:left;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; font-family: 'Trirong', serif;">CLICK TO NEXT </div>
					</li>
					<!-- SLIDE  -->
					<li data-index="rs-2979" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="images/slider/slider2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Packaging" data-param1="02" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="images/slider/slider2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						...
						<div class="tp-caption tp-shape tp-shapewrapper  rs-parallaxlevel-3" 
							...
							style="z-index: 12;text-transform:left;background-color:rgb(252, 169, 1);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>
						...
						<div class="tp-caption Creative-SubTitle   tp-resizeme rs-parallaxlevel-2" 
							...
							style="z-index: 13; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">WE ASSURE YOU OF OUR BEST SERVICES AT ALL TIMES</div>
						...
						<div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1" 
							...
							style="z-index: 14; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">Secure<br/>Packaging</div>
						...
						<div class="tp-caption tp-shape tp-shapewrapper  rs-parallaxlevel-3" 
							...
							style="z-index: 15;text-transform:left;background-color:rgb(252, 169, 1);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>
						...
						<div class="tp-caption Creative-Button rev-btn  rs-parallaxlevel-15" 
							...
							style="z-index: 16; white-space: nowrap;text-transform:left;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; font-family: 'Trirong', serif;">CLICK TO NEXT </div>
					</li>
					<!-- SLIDE  -->
					<li data-index="rs-2980" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="images/slider/slider4.jpeg"  data-rotate="0"  data-saveperformance="off"  data-title="Logistics" data-param1="03" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="images/slider/slider4.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						...
						<div class="tp-caption Creative-SubTitle   tp-resizeme rs-parallaxlevel-2" 
							...
							style="z-index: 13; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">WE PROVIDE A LOGISTICS FOR OUR CUSTOMERS GOODS</div>
						...
						<div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1" 
							...
							style="z-index: 14; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">Secured<br/>Logistic</div>
					...
					<!-- SLIDE  -->
					<li data-index="rs-2981" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="images/slider/slider5.jpeg"  data-rotate="0"  data-saveperformance="off"  data-title="Delivery" data-param1="04" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="images/slider/slider5.jpeg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						...
						<div class="tp-caption Creative-SubTitle   tp-resizeme rs-parallaxlevel-2" 
							...
							style="z-index: 13; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">WE ASSURE YOU QUALITY DELIVERY TO SPECIFIED LOCATIONS</div>
						...
						<div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1" 
							...
							style="z-index: 14; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">Secure<br/>Delivery</div>
					...
					<!-- SLIDE  -->
					<li data-index="rs-2982" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="images/slider/slider3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Warehousing" data-param1="05" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
						<!-- MAIN IMAGE -->
						<img src="images/slider/slider3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						...
						<div class="tp-caption tp-shape tp-shapewrapper  rs-parallaxlevel-3" 
							...
							style="z-index: 18;text-transform:left;background-color:rgb(252, 169, 1);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>
						...
						<div class="tp-caption Creative-SubTitle   tp-resizeme rs-parallaxlevel-2" 
							...
							style="z-index: 19; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">WE ASSURE YOU OF OUR BEST SERVICES AT ALL TIMES</div>
						...
						<div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1" 
							...
							style="z-index: 20; white-space: nowrap;text-transform:left; font-family: 'Trirong', serif;">Safe<br/>Warehousing</div>
						...
						<div class="tp-caption tp-shape tp-shapewrapper  rs-parallaxlevel-3" 
							...
							style="z-index: 21;text-transform:left;background-color:rgb(252, 169, 1);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>
						...
						<div class="tp-caption Creative-Button rev-btn  rs-parallaxlevel-15" 
							...
							style="z-index: 22; white-space: nowrap;text-transform:left;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; font-family: 'Trirong', serif;">BACK TO THE FIRST </div>
					</li>
				</ul>
				...
				<div class="ed_search_form">
					@isset($status)
						<div class="alert alert-block align-items-center alert-primary" style="border: 1px solid red;">
							...
							<p style="color: #fff">{{ ucfirst($status) }}</p>
						</div>
					@endisset
		...
		<div class="row">
			...
			<div class="ed_mostrecomeded_course_slider">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="images/slider/s1.jpg" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
							<h4><a href="#">ground transport</a></h4>
							<p>We service all industries including but not limited to the residential and commercial building industry, mining, oil, gas, engineering and construction and civil infrastructure projects.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="images/slider/s2.jpg" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="images/slider/s3.jpg" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
							<h4><a href="#">packaging & storage</a></h4>
							<p>We service all industries including but not limited to the residential and commercial building industry, mining, oil, gas, engineering and construction and civil infrastructure projects.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="images/slider/s4.jpg" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="images/slider/s5.jpg" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ed_mostrecomeded_course">
						<div class="ed_item_img">
							<img src="images/slider/s6.jpg" alt="item1" class="img-responsive">
						</div>
						<div class="ed_item_description ed_most_recomended_data">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center ed_toppadder30">
					<a href="/services" class="btn ed_btn ed_orange">view  more</a>
				</div>
			</div>
		</div>
    </div><!-- /.container -->
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="ed_video_section_discription">
					...
					<span><a href="/about" class="btn ed_btn ed_orange">know more</a></span>
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12">
	...
	<div class="container">
		<div class="row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-12">
				<div class="ed_contact_form" style="background-color: transparent;">
                    <form action="{{ url('/user') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group align-items-center">
                                    <input type="text" class="form-control form-control-nbr" name="firstname" placeholder="First Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group align-items-center">
                                    <input type="text" class="form-control form-control-nbr" name="lastname" placeholder="Last Name" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group align-items-center">
                        ...
                        <div class="form-group align-items-center">
                            <input type="number" class="form-control" name="quantity" placeholder="Number of Items" required>
                        </div>
                        <div class="form-group align-items-center">
                            <select name="from" required class="form-control">
								<option value="" disabled selected>Where are you delivering from</option>
                        ...
                        <div class="form-group align-items-center">
                            <textarea type="text" cols="30" rows="5" class="form-control" name="from_address" placeholder="From Address" required></textarea>
                        </div>
                        <div class="form-group align-items-center">
                            <select name="to" required class="form-control">
                                <option value="" disabled selected>Where are you delivering to</option>
                                @for ($i = 0; $i < count($locations); $i++)
                                    <option value="{{ $locations[$i]}}"> {{ $locations[$i] }} </option> 
                                @endfor
                            </select>
                        ...
                        <div class="form-group align-items-center">
                            <input type="submit" class="btn ed_btn ed_orange form-control" value="Deliver">
                        </div>
                    </form>
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="ed_clientslider">
					<div id="owl-demo5" class="owl-carousel owl-theme">
						<div class="item">
							<a href="#">
								<img src="images/content/partner1.png" alt="Partner Img" />
							</a>
						</div>
						<div class="item">
							<a href="#">
								<img src="images/content/partner2.png" alt="Partner Img" />
							</a>
						</div>
						<div class="item">
							<a href="#">
								<img src="images/content/partner3.png" alt="Partner Img" />
							</a>
						</div>
						<div class="item">
							<a href="#">
								<img src="images/content/partner4.png" alt="Partner Img" />
							</a>
						</div>
						<div class="item">
							<a href="#">
